  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-5xl flex flex-col lg:flex-row gap-8 items-start justify-center">
        <div className={`hidden lg:flex flex-col gap-6 flex-1 max-w-lg ${state === 'result' ? '!flex' : ''}`}>
          <div className="mb-4">
            ...
            <p className="text-secondary-text leading-relaxed">
              AI 驱动的鸟类鸣叫识别工具。录下一段环境声音，我们会帮用户从复杂背景中找出最可能的鸟种。
            </p>
        ...
        <div
          className={`app-view glass-panel rounded-[40px] w-full max-w-[360px] h-[640px] flex flex-col p-8 shadow-2xl relative overflow-hidden shrink-0 ${state === 'result' ? 'hidden lg:flex' : ''}`}
        >
          <div className="flex justify-between items-center mb-10 z-10">
            <div className="text-2xl font-bold text-accent-green tracking-wider">听鸣鸟</div>
              ...
              {state === 'idle' && (
                ...
                >
                  <div className="text-center">
                    ...
                    <h2 className="text-xl font-bold text-primary-text mb-2">准备好开始识别了吗？</h2>
                    ...
                    <div className="bg-white/60 rounded-3xl p-5 border border-white/40 mb-6">
                      <div className="flex gap-4 mb-6">
                        <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-sm">
                          <img
                            src={BIRD_DATASET[detections[0].species]?.image || DEFAULT_BIRD.image}
                        ...
                        <div>
                          <div className="font-bold text-primary-text">
                            {BIRD_DATASET[detections[0].species]?.nameCn}
                          </div>
